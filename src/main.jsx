...
const router = createBrowserRouter([
    ...
    { path: '/Douze/', element: <Simflouz data={cheats_simflouz}/> },
    { path: '/Douze/Simflouz', element: <Simflouz data={cheats_simflouz} /> },
    { path: '/Douze/Personnage', element: <Simflouz data={cheats_personnage} /> },
    { path: '/Douze/Construction', element: <Simflouz data={cheats_construction} /> }
])
